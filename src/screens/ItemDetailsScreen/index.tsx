...
import { TabParamList, WardrobeItem } from '../../types';
...
type ItemDetailsRouteProp = RouteProp<TabParamList, 'ItemDetails'>;
type ItemDetailsNavigationProp = BottomTabNavigationProp<
  TabParamList,
  'ItemDetails'
>;
...
export default function ItemDetailsScreen() {
  ...
  // Control tab bar visibility based on edit mode
  useLayoutEffect(() => {
